...
; 0x0000D8    5 word(s)  0 % : ayarlar
; 0x00005A   28 word(s)  0 % : bekle
; 0x000092   28 word(s)  0 % : bekle_kesme
; 0x0000CA    7 word(s)  0 % : sifirla
; 0x000004   29 word(s)  0 % : kesme
; 0x00003E   14 word(s)  0 % : main

; RAM usage: 5 bytes (5 local), 1531 bytes free
; Maximum call level: 1
; Total of 113 code words (0 %)
